package com.example.githubsubmissionuser.adapter
...
import com.example.githubsubmissionuser.R
import com.example.githubsubmissionuser.data.ItemsItem
import de.hdodenhof.circleimageview.CircleImageView

class UsersSearchAdapter(val dataUser: List<ItemsItem?>?) :
